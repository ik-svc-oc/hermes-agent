...
def resolve_billing_route(
    ...
    if provider_name == "xai-oauth":
        return BillingRoute(provider="xai-oauth", model=model.split("/")[-1] if model else "", base_url=base_url or "", billing_mode="subscription_included")
